...
<motion.path  {...pathAnimation}
 transition={{ delay: 0.1 }}   d="M349 150L73 150C70.7909 150 69 151.791 69 154L69 174" stroke="currentColor"  strokeOpacity="0.1" />
    ...
    <path d="M284 62.0076L559 62.0076C561.209 62.0076 563 63.7985 563 66.0076L563 195.5" stroke="currentColor" strokeOpacity="0.1"/>
    <g>
    <motion.path 
         {...pathAnimation}
         transition={{ delay: 0.4 }}
    ...
    <path d="M164 172.5L164 108" stroke="currentColor" strokeOpacity="0.1"/>
