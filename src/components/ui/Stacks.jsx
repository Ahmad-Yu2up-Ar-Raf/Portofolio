...
export default function index() {
 ...
 <ScrollElement viewport={{ amount: 0.5, margin: '0px 0px 0px 0px' }}>
    ...
    >
          <Circle ref={div1Ref} className="p-3">
            <Icons.googleDrive />
          </Circle>
       </NeonGradientCard>
          <NeonGradientCard className="w-fit"   neonColors={{ firstColor: "#ff5733", secondColor: "#33ff57" }}
    ...
    >
          <Circle ref={div5Ref} className="p-3">
            <Icons.googleDocs />
          </Circle>
   </NeonGradientCard>
        </div>
    ...
    >
          <Circle ref={div2Ref} className="p-3">
            <Icons.openai />
          </Circle>
          </NeonGradientCard>
          
          <NeonGradientCard className="w-fit">
          <Circle ref={div4Ref} className="size-14   md:size-16 lg:size-20 p-3">
            <Icons.vscode />
          </Circle>
          </NeonGradientCard>
          <NeonGradientCard className="w-fit"   neonColors={{ firstColor: "#ff5733", secondColor: "#33ff57" }}
    ...
    >
          <Circle ref={div7Ref} className="p-3">
            <Icons.messenger />
          </Circle>
          </NeonGradientCard>
        </div>
...
<path fill="#00acc1" d="M24,9.604c-6.4,0-10.4,3.199-12,9.597c2.4-3.199,5.2-4.398,8.4-3.599 c1.826,0.456,3.131,1.781,4.576,3.247C27.328,21.236,30.051,24,36,24c6.4,0,10.4-3.199,12-9.598c-2.4,3.199-5.2,4.399-8.4,3.6 c-1.825-0.456-3.13-1.781-4.575-3.247C32.672,12.367,29.948,9.604,24,9.604L24,9.604z M12,24c-6.4,0-10.4,3.199-12,9.598 c2.4-3.199,5.2-4.399,8.4-3.599c1.825,0.457,3.13,1.781,4.575,3.246c2.353,2.388,5.077,5.152,11.025,5.152 c6.4,0,10.4-3.199,12-9.598c-2.4,3.199-5.2,4.399-8.4,3.599c-1.826-0.456-3.131-1.781-4.576-3.246C20.672,26.764,17.949,24,12,24 L12,24z"></path>
  ...
  zapier: () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" id="Alpinejs-Icon--Streamline-Svg-Logos" height="30" width="30"><desc>Alpinejs Icon Streamline Icon: https://streamlinehq.com</desc><path fill="#77c1d2" d="m18.527775 6.6106 5.2222 5.199325 -5.2222 5.1993 -5.222225 -5.1993 5.222225 -5.199325Z" strokeWidth="0.25"></path><path fill="#2d3441" d="m5.472225 6.6106 10.826325 10.778825H5.8541L0.25 11.809925l5.222225 -5.199325Z" strokeWidth="0.25"></path></svg>
  ),
  messenger: () => (
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" id="Figma--Streamline-Svg-Logos" height="24" width="24"><desc>Figma Streamline Icon: https://streamlinehq.com</desc><path fill="#0acf83" d="M8.0833 23.750025c2.162 0 3.91665 -1.754675 3.91665 -3.916675V15.916675H8.0833c-2.162 0 -3.916675 1.754675 -3.916675 3.916675s1.754675 3.916675 3.916675 3.916675Z" strokeWidth="0.25"></path><path fill="#a259ff" d="M4.166625 11.999975c0 -2.162 1.754675 -3.91665 3.916675 -3.91665h3.91665v7.833325H8.0833c-2.162 0 -3.916675 -1.754675 -3.916675 -3.916675Z" strokeWidth="0.25"></path><path fill="#f24e1e" d="M4.166625 4.166675C4.166625 2.0046675 5.9213 0.25 8.0833 0.25h3.91665v7.833325H8.0833c-2.162 0 -3.916675 -1.75465 -3.916675 -3.91665Z" strokeWidth="0.25"></path><path fill="#ff7262" d="M11.999875 0.25h3.916675c2.162 0 3.91665 1.7546675 3.91665 3.916675 0 2.162 -1.75465 3.91665 -3.91665 3.91665H11.999875V0.25Z" strokeWidth="0.25"></path><path fill="#1abcfe" d="M19.8332 11.999975c0 2.162 -1.75465 3.916675 -3.91665 3.916675s-3.916675 -1.754675 -3.916675 -3.916675 1.754675 -3.91665 3.916675 -3.91665 3.91665 1.75465 3.91665 3.91665Z" strokeWidth="0.25"></path></svg>
  ),
  vscode: () => (
    <svg
      width="100"
