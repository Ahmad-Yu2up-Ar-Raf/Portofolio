...
export default function Tech() {
    return(
        <>
           <Link href={"https://react.dev/"} target="blank" >
              <div className="p-[24px] border-2 gap-[24px]  border-gray-700 group justify-between group flex flex-col rounded-[12px] min-h-[190px] md:min-h-[240px] w-full relative " style={{ 
 boxShadow: "0 1px 0 1px rgba(0,0,0,.02),0 4px 6px rgba(0,0,0,.02),inset 0 0 0 6px #111111",
  ...
  <BorderBeam
 duration={8} size={100}  colorFrom="#61dafb"
 colorTo="#61dafb"
      />
           <Image width={100} height={100} className="size-[44px] flex items-center mb-auto" src='https://nextjs.org/icons/react.svg' alt="image"  />
